/*******************************************************
  ...
  water inputs, following the hydrological equilibrium hypothesis.
  ...
  Assumptions:
   ...
   References:
   - Contreras et al.(2011). Remote sensing  estimates  of  supplementary  water  consumption  by  arid  ecosystems
     of  central  Argentina. Journal of Hydrology, 397(1–2), 10–22.

   - Otta et al. (2022). Dynamics of Irrigated Drylands in Central-Western Argentina (1986–2018).
     Geoacta 44(1): 35-55
*******************************************************/
